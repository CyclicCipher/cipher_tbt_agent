...
Suite: **59 passed** (~20s; `test_column_arithmetic` is the ~16s end-to-end column test, the rest — `test_bg_thalamus`,
...
emergent learning boundary (a continuous sweep over two known objects, and over a known object into a novel one). Rotation is tested
