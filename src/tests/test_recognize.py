"""Pose-invariant object recognition (tbt/recognize.py) — the TBT/Monty fix for the 2019 grid-cell model's explicit
orientation limitation. Recognise a known object at an UNSEEN continuous angle, under partial views, with the object
set learned ONLINE + label-free. Domain-general: only (location, local-descriptor) sensations, no game."""
