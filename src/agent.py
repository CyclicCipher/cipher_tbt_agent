...
Run:  PYTHONPATH=src python -m agent
"""
...
from tasks.games import LockPath, MultiKey                 # noqa: E402

from wm.score import oracle_optimal, per_level_actions       # noqa: E402
from perception.dynamics_perceive import collect                         # the canonical learners (dynamics + E + F)  # noqa: E402
from perception.objects import modal_background                          # noqa: E402
